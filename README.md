...
5. Add an output and connect it through **When true**. Delete the old, now-unreachable output. Run to verify the new route. The list view and connection selects support keyboard operation.
6. Export the validated JSON, reset the example, then import your file. Invalid or oversized imports leave your graph and result intact.

## Built to explain itself

- Editable trigger, transform, condition and output nodes; real connections and numeric layout controls.
